Rails.application.routes.draw do
  get "invoices/index"
  get "invoices/show"
  get "service_usages/index"
  get "service_usages/show"
  get "services/index"
  get "services/show"
  ...
  get "/service_usages", to: "service_usages#index", as: :service_usages
  get "/service_usages/:id", to: "service_usages#show", as: :service_usage
